...
namespace StockDOGE
{
    public class StockVV
    {
        ...
        *///////////////////////////////////////////////////////////////////////
        ...
        public StockVV(string name, double initPrice, int recordLengthMAX)
        {
        ...
        public StockVV(double initPrice, int recordLengthMAX)
        {
            this.price = initPrice; //입력받은 초기 가격
            this.recordPrice = new double[recordLengthMAX];    // 입력받은 recordLength만큼 기록을 남기고 RNN에 사용
            this.recordPrice[0] = this.price;
        ...
        public StockVV(string name, double initPrice)
        {
        ...
        public StockVV(double initPrice)
        {
            this.price = initPrice;
            this.recordPrice = new double[1];
            this.recordPrice[0] = this.price;
